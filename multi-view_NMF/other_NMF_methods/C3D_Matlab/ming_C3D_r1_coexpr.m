...
% ming_C3D_r1_coexpr(file_path, 0.01, 1000, 1, 'abs')
...
if ~isempty(key) 
    ...
    disp('Step 3: PART I, Calling fdrtool to select the cluster nodes is done');
    ...
    disp(['Step 3: begin overlap : filen=',num2str(filen)]);
    tic;
    for r=1:filen
        for s=r+1:filen
            % file r
